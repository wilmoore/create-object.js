# Contributing to create-object

Below are a few ways to make contributing to `create-object` smoother.
...
## Setup
    ...
    git clone https://github.com/wilmoore/create-object.js.git
    cd create-object.js
    npm install
    npm run dev
